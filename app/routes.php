...
$routes->add('asset', new Route('/{controller}/{action}/{id}', array('controller' => 'asset', 'action' => '(js|css|img|font|coffee)', 'id' => '[a-zA-Z\.\-\_]+')));

$routes->add('asset_subfolder', new Route('/{controller}/{action}/{subfolder}/{id}', array('controller' => 'asset', 'action' => '(js|css|img|font|coffee)', 'subfolder' => '[0-9a-zA-Z\_\-]+','id' => '[a-zA-Z\.\-]+')));
